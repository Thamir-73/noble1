...
export default function Navbar() {
  ...
  return (
    <div className="relative">
      <nav className="bg-white bg-opacity-70 backdrop-blur-md text-blue-600 border-b border-[#4CAF50] shadow-sm">
        <div className="container px-4 py-4 flex justify-between items-center">
          <div className="flex items-center">
            ...
            />
            <h2 className="font-bold ml-0 text-gray-300 text-xl">نوبل</h2>
          </div>
